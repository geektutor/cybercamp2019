<?php
/*
	Template Name: Cyber Home Template
*/
      ...
      <section id="about">
        ...
        <section class="curriculum-container">
          ...
          <div class="curriculum-details">
            <div class="curriculumd active" id="wd">
      ...
      <aside>
        <div class="aside-container">
          ...
          <div class="aside-body">
            ...
            <p><b>Payment Method: </b>Cash deposit to Unilag Consult Ltd., <b>2029937936</b>, First Bank Nigeria</p>
            <p> After payment, send a mail with proof of payment to <b>cybercamp19@unilagconsult.com.ng</b> (Kindly include the keyword 'cybercamp' in the detail) </p>
          </div>
        </div>
  ...
  I see myself specializing in Web design and development and game design and development in the future.</q>
    ...
    <section class="sponsors">
      ...
      <div class="sponsor-container">
        <img src="https://unilagconsult.com.ng/cybercamp19/wp/wp-content/uploads/2019/06/Shuttlers-1.jpeg" alt="Shuttlers" width="140px" height="100px">
        <img src="https://unilagconsult.com.ng/cybercamp19/wp/wp-content/uploads/2019/06/Andelas-Teen.Code-1.jpg" alt="Andela" width="140px" height="100px">
      </div>
    </section>
  </main>
